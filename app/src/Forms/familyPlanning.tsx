...
class FamilyPlanning extends React.Component<Props> {
  ...
  async createFamilyPlaningRecord(info: any) {
    ...
    createFamilyPlaning(info, isUpdate)
      .then((val) => {
      ...
      >
        ...
        >
          ...
          <RadioButton
            ...
            name="age"
            title="Age"
            options={AgeRange().familyPlaning}
          />
        ...
        <StepWrapper position={3} title="Oral Pills">
          <Input
            type="text"
        ...
        <StepWrapper position={4} title="IUDS">
          <Input
            type="text"
        ...
        <StepWrapper position={5} title="IMPLANTS">
          <Input
            type="text"
